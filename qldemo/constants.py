...
CS_FLAGSTATUS = 658
CS_SCORES1PLAYER = 659 # 1st place player's name
CS_SCORES2PLAYER = 660 # 2nd place player's name
CS_ROUND_WARMUP = 661
...
CS_AUTHOR = 678             # from the map worldspawn's author field
CS_AUTHOR2 = 679 
CS_ADVERT_DELAY = 680
CS_PMOVEINFO = 681
CS_ARMORINFO = 682
...
#CS_1STPLAYER = 686 
#CS_2NDPLAYER = 687 
CS_SCORE1STPLAYER = 685 # Score of the duel player on the left
CS_SCORE2NDPLAYER = 686 # Score of the duel player on the right
CS_CLIENTNUM1STPLAYER = 687
CS_CLIENTNUM2NDPLAYER = 688
CS_NAME1STPLAYER = 689  # Name of the duel player on the left
CS_NAME2NDPLAYER = 690	# Name of the duel player on the right
CS_ATMOSEFFECT =  691 # unused =  was per-map rain/snow effects
...
CS_STRING_MAP = {
    CS_MATCH_GUID: "matchguid",
    CS_STEAM_ID: "pov_steamid",
    ...
    CS_NAME1STPLAYER: "1stplayer",
    CS_NAME2NDPLAYER: "2ndplayer",
    ...
    CS_REDTEAMBASE: "redteamname",
    CS_BLUETEAMBASE: "blueteamname",
